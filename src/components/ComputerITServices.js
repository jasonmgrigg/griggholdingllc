        ...
        <div className="aboutUsContainer">
          ...
          <div className="itemContainer">
            ...
            <div className="threeServices">
              <h2 className="itemTitle">Smart Phone Maintenance</h2>
              <h3 className="itemText">We can help with a new smart phone, adding it to your network, copying over profiles, or any other issue you may need assistance with.</h3>
            </div>
            ...
            <div className="sixServices">
              <h2 className="itemTitle">Tablet Maintenance</h2>
              <h3 className="itemText">We can help you adding a new tablet to your network, upgrades, and add installation.</h3>
            </div>
          </div>
        </div>
        <Footer />
