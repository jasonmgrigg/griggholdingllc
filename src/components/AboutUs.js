      ...
      <div className="aboutUsContainer">
        ...
        <div className="itemContainer">
          <div className="homeRepairServices">
            ...
            <h3 className="itemText">No repair is too small!  We live nearby and have experinced most common repair problems in Briar Chapel, Fearrington Village and surrounding areas.  It is our highest priority to get the job done right the first time while you get on with your life.</h3>
              <div className="buttonContainer">
                <button className="findOutMore" type="button">FIND OUT MORE</button>
              </div>
          </div>
